...
SIMPLE_ANALYTICS_SCRIPT = env("SIMPLE_ANALYTICS_SCRIPT", "")
SENTRY_DSN = env("SENTRY_DSN", "")
SIMPLE_ANALYTICS_ENABLED = env("SIMPLE_ANALYTICS", "").lower() in ("1", "true", "yes")
TESTING = env("H1B_TESTING", "").lower() in ("1", "true", "yes")
